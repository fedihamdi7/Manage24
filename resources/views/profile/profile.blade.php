        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">{{__('Role')}}</label><input type="text" readonly class="form-control" placeholder="{{__('Role')}}" value="{{__($user->role) }}" name="role">@error('role')<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>@enderror </div>
                    ...
                    <div class="col-md-12"><label class="labels">{{__('Adresse')}}</label><input type="text" class="form-control" placeholder="{{__('Adresse 1')}}" value="{{$user->adresse1 }}" name="adresse1">@error('adresse1')<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>@enderror </div>
